...
to go
  ...
  export-plot "Distâncias" "plot.csv"
...
;;######### Cáculo da primeira parte da equação do Extend Korf ###############################
...
to manhattan1AG
  ...
  [
    ...
    let x runresult item 2 manhattanP1
    let y runresult item 6 manhattanP1
    let xc runresult item 0 manhattanP1
    let yc runresult item 4 manhattanP1
    let op1 item 1 manhattanP1
    let op2 item 3 manhattanP1
    let op3 item 5 manhattanP1
    ...
    ask patch xc yc [
      foreach [0 45 90 135 180 225 270 315] [
        ask patch-at-heading-and-distance ? 1 [
          let hipo distancexy x y
          set distPolarAG (abs catadj hipo dir) + (abs catop hipo dir)
        ]
        set manhattanPresaAG lput distPolarAG manhattanPresaAG
      ]
    ]
    ...
    [
      ...
      ask patch xc yc [
        foreach [0 45 90 135 180 225 270 315] [
          ...
          set manhattanPredadorAG lput distPolarAG manhattanPredadorAG
...
to setar-distancias
  show [distance myself] of presa 0
end
...
to-report realizar-troca [lista]
  ...
  set lista trocar "C" "xCi" lista
  set lista trocar "D" "xC1" lista
  set lista trocar "E" "xC2" lista
  set lista trocar "F" "xC3" lista
  set lista trocar "G" "yCi" lista
  set lista trocar "H" "yC1" lista
  set lista trocar "I" "yC2" lista
  set lista trocar "J" "yC3" lista
...
to dividir-equacao
  set manhattanP1 sublist equacao 0 7
  set manhattanP2 sublist equacao 11 34
  set manhattanP1 realizar-troca manhattanP1
  set manhattanP2 realizar-troca manhattanP2
end
...
"" ""
PENS
"Predador 1" 1.0 0 -13840069 true "" "plot [distance predador 1] of presa 0"
"Predador 2" 1.0 0 -13345367 true "" "plot [distance predador 2] of presa 0"
"Predador 3" 1.0 0 -2674135 true "" "plot [distance predador 3] of presa 0"
"Predador 4" 1.0 0 -1184463 true "" "plot [distance predador 4] of presa 0"
...
1301
502
Somatório Distâncias Predadores
NIL
NIL
0.0
10.0
...
"" ""
PENS
"Predador 1" 1.0 0 -13840069 true "" "plot [distance predador 1] of predador 1 + [distance predador 1] of predador 2 + [distance predador 1] of predador 3 + [distance predador 1] of predador 4"
"Predador 2" 1.0 0 -13345367 true "" "plot [distance predador 2] of predador 1 + [distance predador 2] of predador 2 + [distance predador 2] of predador 3 + [distance predador 2] of predador 4"
"Predador 3" 1.0 0 -2674135 true "" "plot [distance predador 3] of predador 1 + [distance predador 3] of predador 2 + [distance predador 3] of predador 3 + [distance predador 3] of predador 4"
"Predador 4" 1.0 0 -1184463 true "" "plot [distance predador 4] of predador 1 + [distance predador 4] of predador 2 + [distance predador 4] of predador 3 + [distance predador 4] of predador 4"
